    ...
    int a_Protocol)
{
    ...
    aibufhandle = (void*)calloc(result.addressCount * sizeof(*aibuf), 1);
    if (aibufhandle == NULL)
    {
        freeaddrinfo(ailist);
