...
static void _Transform(uint32_t* s, const uint32_t* chunk)
{
    ...
    Round(
        ...
        &h,
        0x428a2f98,
        w0 = oe_to_big_endian_u32(chunk[0]));
    Round(
        h,
        a,
        b,
        ...
        &g,
        0x71374491,
        w1 = oe_to_big_endian_u32(chunk[1]));
    Round(
        g,
        h,
        a,
        ...
        &f,
        0xb5c0fbcf,
        w2 = oe_to_big_endian_u32(chunk[2]));
    Round(
        f,
        g,
        h,
        ...
        &e,
        0xe9b5dba5,
        w3 = oe_to_big_endian_u32(chunk[3]));
    Round(
        e,
        f,
        g,
        ...
        &d,
        0x3956c25b,
        w4 = oe_to_big_endian_u32(chunk[4]));
    Round(
        d,
        e,
        f,
        ...
        &c,
        0x59f111f1,
        w5 = oe_to_big_endian_u32(chunk[5]));
    Round(
        c,
        d,
        e,
        ...
        &b,
        0x923f82a4,
        w6 = oe_to_big_endian_u32(chunk[6]));
    Round(
        b,
        c,
        d,
        ...
        &a,
        0xab1c5ed5,
        w7 = oe_to_big_endian_u32(chunk[7]));
    Round(
        a,
        b,
        c,
        ...
        &h,
        0xd807aa98,
        w8 = oe_to_big_endian_u32(chunk[8]));
    Round(
        h,
        a,
        b,
        ...
        &g,
        0x12835b01,
        w9 = oe_to_big_endian_u32(chunk[9]));
    Round(
        g,
        h,
        a,
        ...
        &f,
        0x243185be,
        w10 = oe_to_big_endian_u32(chunk[10]));
    Round(
        f,
        g,
        h,
        ...
        &e,
        0x550c7dc3,
        w11 = oe_to_big_endian_u32(chunk[11]));
    Round(
        e,
        f,
        g,
        ...
        &d,
        0x72be5d74,
        w12 = oe_to_big_endian_u32(chunk[12]));
    Round(
        d,
        e,
        f,
        ...
        &c,
        0x80deb1fe,
        w13 = oe_to_big_endian_u32(chunk[13]));
    Round(
        c,
        d,
        e,
        ...
        &b,
        0x9bdc06a7,
        w14 = oe_to_big_endian_u32(chunk[14]));
    Round(
        b,
        c,
        d,
        ...
        &a,
        0xc19bf174,
        w15 = oe_to_big_endian_u32(chunk[15]));
...
void sha256_transform(void* input_data, uint32_t digest[8], uint64_t num_blks)
{
    ...
    uint32_t chunk[BLKSZ / sizeof(uint32_t)];

    while (num_blks--)
    {
        memcpy(chunk, p, BLKSZ);
