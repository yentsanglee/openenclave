...
class oe_fd_hostfs_file_system : public oe_fd_file_system
{
  public:
    oe_fd_hostfs_file_system()
    {
        ...
        OE_TEST(oe_mount(OE_DEVID_INSECURE_FILE_SYSTEM, "/", 0) == 0);
    }

    ~oe_fd_hostfs_file_system()
    {
        OE_TEST(oe_unmount(OE_DEVID_INSECURE_FILE_SYSTEM, "/") == 0);
    }
};
...
class oe_fd_sgxfs_file_system : public oe_fd_file_system
{
  public:
    oe_fd_sgxfs_file_system()
    {
        ...
        OE_TEST(oe_mount(OE_DEVID_ENCRYPTED_FILE_SYSTEM, "/", 0) == 0);
    }

    ~oe_fd_sgxfs_file_system()
    {
        OE_TEST(oe_unmount(OE_DEVID_ENCRYPTED_FILE_SYSTEM, "/") == 0);
    }
};
