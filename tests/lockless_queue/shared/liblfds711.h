...
//  #pragma prefast( disable : 28113 28182 28183, "blah" )
  ...
  /***** includes *****/
  #include "lfds711_porting_abstraction_layer_compiler.h"
  #include "lfds711_porting_abstraction_layer_operating_system.h"
  #include "lfds711_porting_abstraction_layer_processor.h"

  #include "lfds711_prng.h"                                       // TRD : misc requires prng
  #include "lfds711_misc.h"                                       // TRD : everything after depends on misc
...
//  #include "liblfds711/lfds711_queue_bounded_singleproducer_singleconsumer.h"
  #include "lfds711_queue_unbounded_manyproducer_manyconsumer.h"
